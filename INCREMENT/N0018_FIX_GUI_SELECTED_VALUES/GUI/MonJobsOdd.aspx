...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="p_Detail_lvl2" runat="server" EnableViewState="False" CssClass="PortletBoxInner" Visible="False">
            <p>
                ...
                <asp:LinkButton ID="BJobControl_ABORT" runat="server"  CommandName="COMMAND_JOB_ABORT" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Abort</span></asp:LinkButton>
                <asp:LinkButton ID="BJobControl_MARKASFINISHEDSUCC" runat="server"  CommandName="COMMAND_JOB_MARKASFINISHEDSUCC" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Mark as Finished Succesfully</span></asp:LinkButton>
                <asp:LinkButton ID="BJobControl_MARKASFAILED" runat="server"  CommandName="COMMAND_JOB_MARKASFAILED" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Mark as Failed</span></asp:LinkButton>
                </asp:Panel>     
