<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MonJobsRunning.aspx.cs" Inherits="PDC.MonJobsRunning" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <asp:SqlDataSource ID="SqlDataSource_gv_Detail_lvl1" runat="server" 
        ...
        SelectCommand="PCKG_GUI.SP_GUI_VIEW_JOBS_RUNNING" 
    ...
    <asp:Panel ID="p_Detail_lvl1" runat="server" EnableViewState="False" CssClass="PortletBoxInner">
            <p>
                <span class="ModuleHeader">Running Jobs&nbsp;(<asp:Label ID="lDetailRowCount" runat="server" Text="-" EnableViewState="False"></asp:Label>)</span>
            </p>
    ...
    <asp:Panel ID="p_Detail_lvl2" runat="server" EnableViewState="False" CssClass="PortletBoxInner" Visible="False">
            <p>
                ...
                <asp:LinkButton ID="BJobControl_MARKASFINISHEDSUCC" runat="server"  CommandName="COMMAND_JOB_MARKASFINISHEDSUCC" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Mark as Finished Successfully</span></asp:LinkButton>
            ...
            <asp:DetailsView ID="gv_Detail_lvl2" runat="server" DataSourceID="SqlDataSource_gv_Detail_lvl2"
                CellPadding="2" CellSpacing="1" GridLines="Both" CssClass="PDCTbl" EmptyDataText="No rows"
                 EnableViewState="False" ondatabound="gv_Detail_lvl2_DataBound">
