...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="p_Detail_lvl2" runat="server" EnableViewState="False" CssClass="PortletBoxInner" Visible="False">
        ...
        <asp:Panel ID="p_CONTROL" runat="server"  EnableViewState="False" Visible="False">
            <asp:LinkButton ID="BJobControl_RESTART" runat="server"  CommandName="COMMAND_JOB_RESTART" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Restart</span></asp:LinkButton>
            <asp:LinkButton ID="BJobControl_RESUME" runat="server"  CommandName="COMMAND_JOB_RESUME" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Resume</span></asp:LinkButton>
