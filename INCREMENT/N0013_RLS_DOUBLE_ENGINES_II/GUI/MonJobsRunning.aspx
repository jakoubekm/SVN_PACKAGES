...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="p_Detail_lvl2" runat="server" EnableViewState="False" CssClass="PortletBoxInner" Visible="False">
            <p>
                ...
                <asp:LinkButton ID="BJobControlXXX1" runat="server"  CommandName="COMMAND_JOB_MARKASFINISHEDSUCC" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Mark as Finished Successfully</span></asp:LinkButton>
