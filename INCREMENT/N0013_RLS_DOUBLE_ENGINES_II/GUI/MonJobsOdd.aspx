<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MonJobsOdd.aspx.cs" Inherits="PDC.MonJobsOdd" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource_gv_Detail_lvl1" runat="server" 
        ...
        SelectCommand="PCKG_GUI.SP_GUI_VIEW_JOBS_ODD" 
    ...
    <asp:Panel ID="p_Detail_lvl1" runat="server" EnableViewState="False" CssClass="PortletBoxInner">
            <p>
                <span class="ModuleHeader">Odd Jobs&nbsp;(<asp:Label ID="lDetailRowCount" runat="server" Text="-" EnableViewState="False"></asp:Label>)</span>
            </p>
            ...
            <div class="scrollable"><asp:GridView ID="gv_Detail_lvl1" runat="server" DataKeyNames="JOB_ID" DataSourceID="SqlDataSource_gv_Detail_lvl1"
                ...
                AllowPaging="True" PageSize="<%$ AppSettings:DefaultPageItemCount %>" OnDataBound="gv_Detail_lvl1_DataBound"
                PagerSettings-Position="TopAndBottom" 
                PagerSettings-Mode="NumericFirstLast" ClientIDMode="Predictable" 
                onrowdatabound="gv_Detail_lvl1_RowDataBound">
                <Columns>
                    ...
                    <asp:BoundField DataField="EXP_AVG_FINISH" HeaderText="EXP_AVG_FINISH" ReadOnly="True" SortExpression="EXP_AVG_FINISH" />
    ...
    <asp:Panel ID="p_Detail_lvl2" runat="server" EnableViewState="False" CssClass="PortletBoxInner" Visible="False">
            <p>
                ...
                <asp:LinkButton ID="BJobControlAbort" runat="server"  CommandName="COMMAND_JOB_ABORT" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Abort</span></asp:LinkButton>
                <asp:LinkButton ID="BJobControlXXX1" runat="server"  CommandName="COMMAND_JOB_MARKASFINISHEDSUCC" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Mark as Finished Succesfully</span></asp:LinkButton>
                <asp:LinkButton ID="BJobControlXXX2" runat="server"  CommandName="COMMAND_JOB_MARKASFAILED" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Mark as Failed</span></asp:LinkButton>
                </asp:Panel>     
