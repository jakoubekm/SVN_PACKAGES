<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MonJobsFailed.aspx.cs" Inherits="PDC.MonJobsFailed" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource_gv_Detail_lvl1" runat="server" 
        ...
        SelectCommand="PCKG_GUI.SP_GUI_VIEW_JOBS_FAILED" 
    ...
    <asp:Panel ID="p_Detail_lvl1" runat="server" EnableViewState="False" CssClass="PortletBoxInner">
            <p>
                <span class="ModuleHeader">Failed Jobs&nbsp;(<asp:Label ID="lDetailRowCount" runat="server" Text="-" EnableViewState="False"></asp:Label>)</span>
            </p>
            ...
            <div class="scrollable"><asp:GridView ID="gv_Detail_lvl1" runat="server" DataKeyNames="JOB_ID" 
                ...
                PagerSettings-Mode="NumericFirstLast" 
                 ViewStateMode="Disabled" DataSourceID="SqlDataSource_gv_Detail_lvl1" >
                <Columns>
    ...
    <asp:Panel ID="p_Detail_lvl2" runat="server" EnableViewState="False" CssClass="PortletBoxInner" Visible="False">
        ...
        <asp:Panel ID="p_CONTROL" runat="server"  EnableViewState="False" Visible="False">
            <asp:LinkButton ID="BJobControlXXX1" runat="server"  CommandName="COMMAND_JOB_RESTART" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Restart</span></asp:LinkButton>
            <asp:LinkButton ID="BJobControlXXX2" runat="server"  CommandName="COMMAND_JOB_RESUME" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Resume</span></asp:LinkButton>
            <asp:LinkButton ID="BJobControlXXX3" runat="server"  CommandName="COMMAND_JOB_MARKASFINISHED" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Mark as Finished</span></asp:LinkButton>
        </asp:Panel>      
