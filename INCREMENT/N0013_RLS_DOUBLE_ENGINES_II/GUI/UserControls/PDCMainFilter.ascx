        ...
        <div class="portlet-minimum-height">
            <div class="PortletBoxInnerFilter" align="center">
                ...
                <table class="PDCStatTableFilter" border="0" cellspacing="1" cellpadding="2">
                    ...
                    <tbody>
                        <tr><td class="PDCStatTableFilter">Job Name</td><td class="PDCStatTableFilterValue"><asp:TextBox ID="TFilterJobName" runat="server" Text=""></asp:TextBox></td><td class="PDCStatTableFilterValue"><asp:CheckBox ID="TFilterJobNameWC" runat="server" Text="" ToolTip="Discard & Close" CssClass="PDCStatTableFilterValue" Checked="true" /></td></tr>
                        <tr><td class="PDCStatTableFilter">Stream Name</td><td class="PDCStatTableFilterValue"><asp:TextBox ID="TFilterStreamName" runat="server" Text=""></asp:TextBox></td><td class="PDCStatTableFilterValue"><asp:CheckBox ID="TFilterStreamNameWC" runat="server" Text="" ToolTip="Discard & Close" CssClass="PDCStatTableFilterValue" Checked="true" /></td></tr>
                        <tr><td class="PDCStatTableFilter">Table Name</td><td class="PDCStatTableFilterValue"><asp:TextBox ID="TFilterTableName" runat="server" Text=""></asp:TextBox></td><td class="PDCStatTableFilterValue"><asp:CheckBox ID="TFilterTableNameWC" runat="server" Text="" ToolTip="Discard & Close"  CssClass="PDCStatTableFilterValue" Checked="true" /></td></tr>
                        <tr><td class="PDCStatTableFilter">Job Type</td><td class="PDCStatTableFilterValue"><asp:TextBox ID="TFilterJobType" runat="server" Text=""></asp:TextBox></td><td class="PDCStatTableFilterValue"><asp:CheckBox ID="TFilterJobTypeWC" runat="server" Text="" ToolTip="Discard & Close"  CssClass="PDCStatTableFilterValue" Checked="true" /></td></tr>
                        <tr><td class="PDCStatTableFilter">Job Category</td><td class="PDCStatTableFilterValue"><asp:TextBox ID="TFilterJobCategory" runat="server" Text=""></asp:TextBox></td><td class="PDCStatTableFilterValue"><asp:CheckBox ID="TFilterJobCategoryWC" runat="server" Text="" ToolTip="Discard & Close" CssClass="PDCStatTableFilterValue" Checked="true" /></td></tr>
                        <tr><td class="PDCStatTableFilter">Phase</td><td class="PDCStatTableFilterValue"><asp:TextBox ID="TFilterPhase" runat="server" Text="" ToolTip="Discard & Close"></asp:TextBox></td><td class="PDCStatTableFilterValue"><asp:CheckBox ID="TFilterPhaseWC" runat="server" Text="" ToolTip="Discard & Close" CssClass="PDCStatTableFilterValue" Checked="true" /></td></tr>                     
                    </tbody>
                </table>
