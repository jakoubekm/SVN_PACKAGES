...
#O2 specific
##########
($exit_cd == 0) and $exit_cd = run_SQL_procedure ("PCKG_FWRK","SP_LND_CHECK_SOURCE_DEL");
($exit_cd == 0) and $exit_cd = run_SQL_procedure ("PCKG_SNFR_STG","SP_LND_CHECK_SOURCE_DEL");
($exit_cd == 0) and $exit_cd = run_SQL_procedure ("PCKG_SNFR_STG_OPR","SP_LND_CHECK_SOURCE_DEL");
