<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ControlUnblock.aspx.cs" Inherits="PDC.ControlUnblock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="p_Detail_lvl1" runat="server" EnableViewState="False" CssClass="PortletBoxInner">
            ...
            <p>
                <span class="ModuleHeader">Blocked Jobs&nbsp;(<asp:Label ID="lDetailRowCount" runat="server" Text="-" EnableViewState="False"></asp:Label>)</span>
            </p>
        ...
        SelectCommand="PCKG_GUI.SP_GUI_VIEW_JOBS_BLOCKED" 
        SelectCommandType="StoredProcedure" >
          <SelectParameters>
            ...
            <asp:Panel ID="Panel1" runat="server"  EnableViewState="False">
                <asp:LinkButton ID="BJobControl_UNBLOCK" runat="server"  CommandName="COMMAND_JOB_UNBLOCK" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Mark as Unblocked</span></asp:LinkButton>
            </asp:Panel> 
            <div class="breaker_portlet">&nbsp;</div> 
