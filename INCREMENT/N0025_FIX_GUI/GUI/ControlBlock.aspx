<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ControlBlock.aspx.cs" Inherits="PDC.ControlBlock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="p_Detail_lvl1" runat="server" EnableViewState="False" CssClass="PortletBoxInner">
            ...
            <p>
                <span class="ModuleHeader">Not-Blocked Jobs&nbsp;(<asp:Label ID="lDetailRowCount" runat="server" Text="-" EnableViewState="False"></asp:Label>)</span>
            </p>
        ...
        SelectCommand="PCKG_GUI.SP_GUI_VIEW_JOBS_UNBLOCKED" 
        SelectCommandType="StoredProcedure" >
          <SelectParameters>
            ...
            <asp:Panel ID="Panel1" runat="server"  EnableViewState="False">
                <asp:LinkButton ID="BJobControl_BLOCK" runat="server"  CommandName="COMMAND_JOB_BLOCK" CommandArgument="true" OnCommand="BPDCCommandPressed" CssClass="PDCButton"><span>Mark as Blocked</span></asp:LinkButton>
            </asp:Panel> 
      <div class="breaker_portlet">&nbsp;</div> 
    </asp:Panel>
